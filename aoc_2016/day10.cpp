...
std::vector<std::string> splitter(std::string payload, char delimiter)
{
...
using BotMap = std::map<std::string, Bot>;
...
void solve_puzzle_1(std::string payload, int a=2, int b=5)
{

    auto lines = splitter(payload, '\n');
    BotMap bots;
