...
def check_AABB(data):
    for i in range(0, len(data), 1):
        if data[i:i + 2] == data[i + 2:i + 4][::-1] and not data[i:i + 2] == data[i + 2:i + 4]:
            return True
...
t5 = "wysextplwqpvipxdv[srzvtwbfzqtspxnethm]syqbzgtboxxzpwr[kljvjjkjyojzrstfgrw]obdhcczonzvbfby[svotajtpttohxsh]cooktbyumlpxostt"
t6 = "wysextplwqpvipxdvabba[srzvtwbfzqtspxnethm]xxxxsyqbzgtboxxzpwr[kljvjjkjyojzrstfgrw]obdhcczonzvbfby[svotajtpttohxsh]cooktbyumlpxostt"
t7 = "abba[bttp]bttb[xxew]ddaa"

print('t1: ', solution1(t1))
print('t2: ', solution1(t2))
print('t3: ', solution1(t3))
print('t4: ', solution1(t4))
